...
const PageLayout = ({
  ...
  <>
    ...
    {/* <div className="bg-cover bg-top bg-gradient dark:bg-left dark:bg-dark-gradient"> */}
    <div className="bg-cover bg-top bg-gradient-to-bl from-green-200 via-green-400 to-green-500">
      {/*  */}
      <script>
